...
//       navigate('/formToggle'); // Redirect to login page instead of logging out
//       return;
//     }
...
//           className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded w-full sm:w-auto transition-colors"
//         >
//           Logout
//         </button>
//       </div>
